...
##Print results:
print(round(rbind(`Estimated Parameter` = SS_oil_1F$estimated_parameters, 
...
```{r}
print(matrix(c(SS_oil_1F$MLE, SS_oil_2F$`Log-Likelihood`), 
...
```{r}
print(round(rbind("One-Factor" = SS_oil_1F$`Information Criteria`, 
                  "Two-Factor" = SS_oil_2F$`Information Criteria`), 4))
```
...
print(round(t(SS_oil_2F[["Term Structure Fit"]]),4))
```
...
Option_prices[1,1] <- European_option_value(x_0 = SS_oil_1F$x_t,
                                         parameters = SS_oil_1F$estimated_parameters,
                                         futures_maturity = 2,
                                         option_maturity  = 1,
                                         K = 20,
...
Option_prices[1,2] <- American_option_value(x_0 = SS_oil_1F$x_t,
                                         parameters = SS_oil_1F$estimated_parameters,
                                         futures_maturity = 2,
                                         option_maturity = 1,
                                         K = 20,
...
Option_prices[2,1] <- European_option_value(x_0 = SS_oil_2F$x_t,
                                         parameters = SS_oil$two_factor,
                                         futures_maturity = 2,
                                         option_maturity = 1,
                                         K = 20,
...
Option_prices[2,2] <- American_option_value(x_0 = SS_oil_2F$x_t,
                                         parameters = SS_oil$two_factor,
                                         futures_maturity = 2,
                                         option_maturity = 1,
                                         K = 20,
